...
## Final Work Preview
![](./static-viz/final_preview.png)


## How to Generate the Graphs
All the visualization can be replicated by running the code in ./src/global_findex_viz.ipynb. 

Run `uv_sync` in the terminal to install all necessary packages.
